...
def _batch_norm2d(
    ...
    tensor, mean, var = func(input, weight, bias, eps, training, momentum, running_mean, running_var)
...
def _batch_norm2d_backward(output_grad, mean, var, input, weight, bias, eps):
    func = BackendDispatcher.instance().dispatch(input.device.type, "batch_norm2d_backward")
